...
<html lang="en">
  ...
  <body>
		...
		<div class="row"> 
			...
			<div class="col-8 px-0 my-2"> 
						...
						<?php 
							...
							$query = mysqli_query($con, "SELECT * FROM inst");
						 ?>
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div><button class="btn_edit btn">Редактировать</button></div>		
						<div class="form edit" style="display: none;">
							<form  action="update.php" method="GET">
								<input type="" name="text" placeholder="text">
								<input type="" name="img" placeholder="image">
								<input type="hiden" name="id" placeholder="id" value="<?php echo $post['id'] ?>">
	...
	<script type="text/javascript">
		...
		let btn = document.querySelectorAll('.btn_edit');
